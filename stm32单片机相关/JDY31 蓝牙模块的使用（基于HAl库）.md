...
4，波特率选择9600，与我们的蓝牙默认配置一样
 ...
 ![image-20250830151033661](./assets/image-20250830151033661.png) 
...
选择DMA Setting 选项卡，点击add添加该串口的RX和TX
 ...
 ![](./assets/image-20250830152053566.png) 
...
选择NVIC选项卡， 在USART处开启全局中断。
 ...
 ![](./assets/image-20250830152353172.png) 
...
在Private variables私有变量中的User code中定义一个数组，数组名自拟，长度按需求设置，用于接收存储DMA的数据
 ...
 ![](./assets/image-20250830154251781.png) 
...
所以在这里我们就选择关掉就好（实测关不关效果都一样）
 ...
 ![](./assets/image-20250830153201094.png)  
...
该弱定义函数可在uart.c中找到
 ...
 ![](./assets/image-20250830164816614.png)  
...
![](./assets/image-20250830170919058.png) 
...
![](./assets/image-20250831082516558.png)  
...
（以下是商家提供的串口调试助手，其他调试助手程序也是一样用的，但是注意要选对 串口号 和 波特率）
 ...
 ![](./assets/image-20250831084534359.png) 
...
至此，两个设备就完成了连接。
 ...
 ![image-20250831090003861](./assets/image-20250831090003861.png) ![image-20250831090117241](./assets/image-20250831090117241.png)
...
<img src="./assets/image-20250831092740631.png" alt="image-20250831092740631" style="zoom:50%;" />
...
<img src="./assets/image-20250831092920060.png" alt="image-20250831092920060" style="zoom:33%;" />
